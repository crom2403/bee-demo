...
let lastTrailTime1 = 0,
  lastTrailTime2 = 0
const trailElements1 = [],
  trailElements2 = []

let isBee1Stunned = false,
  isBee2Stunned = false
...
const createTrail = (x, y, elements) => {
...
function animate() {
  ...
  const prevBeeX1 = beeX1,
    prevBeeY1 = beeY1
  const prevBeeX2 = beeX2,
    prevBeeY2 = beeY2
  ...
  if (!isBee1Stunned) {
    ...
    velocityX1 *= friction
    velocityY1 *= friction
    rotation1 += spinSpeed * (1 / 60) // Assuming 60 FPS
  }
  if (!isBee2Stunned) {
  ...
  if (
    ...
    createTrail(beeX1 - beeSize1 / 4, beeY1 - beeSize1 / 4, trailElements1)
  ...
  if (
    ...
    createTrail(beeX2 - beeSize2 / 4, beeY2 - beeSize2 / 4, trailElements2)
